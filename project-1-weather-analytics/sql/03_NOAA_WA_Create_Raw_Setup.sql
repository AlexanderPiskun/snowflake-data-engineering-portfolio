...
CREATE OR REPLACE TRANSIENT TABLE NOAA_WEATHER_METRICS_TS AS
SELECT *
FROM SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.NOAA_WEATHER_METRICS_TIMESERIES;

CREATE OR REPLACE TRANSIENT TABLE NOAA_WEATHER_STATION_INDEX AS
SELECT *
FROM SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE.NOAA_WEATHER_STATION_INDEX;

CREATE OR REPLACE TRANSIENT TABLE NOAA_WATER_SUPPLY_TS AS
SELECT *
